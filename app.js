...
console.log('Exercise 2 Result:', isAdult(80));
...
console.log('Exercise 4 Result:', generateEmail("lulwalsayegh", "gmail.com"));
...
console.log('Exercise 5 Result:', greetUser("Zain", "afternoon"));
...
Complete the exercise in the space below: 32 * 1.8 + 32
*/
...
function basicCalculator (numA, numB, str){
    if (str === 'add'){
        return (numA + numB)
